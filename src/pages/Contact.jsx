...
export default function Contact() {
  ...
  return (
    <section ref={pageRef} className="mx-auto max-w-6xl space-y-6 px-4 py-10 pt-24">
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <p className="page-fade-up mt-2 text-slate-700">
          Reservations recommended for dinner service.
        </p>
      </div>
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="page-fade-up rounded-lg border border-slate-200 p-4">
